...
export const getBackpack = (entity: Entity): Entity | undefined => {
  return getEntityByRole(entity, EntityRoleEnum.BACKPACK)
}
...
export const getContainerItemAt = (
  ...
  return getEntitiesByRole(container, EntityRoleEnum.ITEM).find((item) => {
...
export const getFirstContainerItem = (container: Entity): Entity | undefined =>
  getContainerItemAt(container, 1)
